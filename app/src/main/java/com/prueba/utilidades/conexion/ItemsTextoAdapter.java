...
public class ItemsTextoAdapter extends BaseAdapter {
	private Context context;
	private ArrayList<ItemTexto> items;

	public ItemsTextoAdapter(Context context, ArrayList<ItemTexto> items) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ItemTexto item = this.items.get(position);
